...
import { FaArrowLeft, FaMapMarkerAlt, FaPhone, FaEnvelope, FaClock, FaPaperPlane, FaCheckCircle, FaHeadset, FaBuilding, FaGlobe } from 'react-icons/fa';
  ...
  const faqs = [
    {
      ...
      answer: "We recommend booking at least 2-3 weeks in advance for domestic tours and 1-2 months for international tours to ensure availability."
    },
    {
      question: "What is your cancellation policy?",
      answer: "We offer free cancellation up to 48 hours before the tour departure. Cancellations made less than 48 hours in advance may incur a fee."
    },
    {
      question: "Do you offer customized tours?",
      answer: "Yes, we specialize in creating personalized itineraries based on your interests, budget, and schedule. Contact us for a custom tour package."
    },
    {
      question: "What payment methods do you accept?",
      answer: "We accept all major credit cards, debit cards, bank transfers, and digital payment methods like Apple Pay and Google Pay."
    }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Have questions or need help planning your trip? Our team is ready to assist you.</p>
          </div>
        </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <div className="bg-white rounded-2xl shadow-xl p-8 h-full">
              ...
              <p className="text-gray-600 mb-8">
                Our dedicated team of travel experts is available to assist you with any questions about our tours, destinations, or booking process. We're committed to providing you with exceptional service.
              </p>
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Find answers to common questions about our tours and services</p>
          </motion.div>
