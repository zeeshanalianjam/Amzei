      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {destinations.map((destination) => (
            <div key={destination.id} className="card hover-lift animate-slide-up">
              ...
              <div className="p-6">
                ...
                <Link to={`/destination/${destination.id}`} className="text-orange-500 font-semibold hover:text-orange-600 transition-colors">
                  Learn More →
                </Link>
              </div>
            </div>
